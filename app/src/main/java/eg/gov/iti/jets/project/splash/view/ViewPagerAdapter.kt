...
class ViewPagerAdapter(var context:Context): PagerAdapter() {
    ...
    var pagerList:List<Pager> = listOf(
        Pager(context.getString(R.string.header1),context.getString(R.string.body1),
            R.drawable.pager1
        ),
        Pager(context.getString(R.string.header2),context.getString(R.string.body2),
            R.drawable.pager2
        ),
        Pager(context.getString(R.string.header3),context.getString(R.string.body3),
            R.drawable.pager3
        ),
        Pager(context.getString(R.string.header4),context.getString(R.string.body4),
            R.drawable.pager4
        ))
